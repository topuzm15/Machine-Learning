...
import cifar10
from cifar10 import img_size, channels, num_classes
import numpy as np
import time
...
#print('Training set: ' + str(len(train_img)) + ' Testing set: ' + str(len(test_img)))
